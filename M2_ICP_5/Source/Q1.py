...
model.fit(X_train[0:2000], Y_train[0:2000], epochs=5, validation_data=(X_test[0:2000], Y_test[0:2000]), callbacks=[tensorboard])
print(score)
print(acc)
...
# load the earlier trained model and preform required task
